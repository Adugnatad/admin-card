              ...
              {paginatedIndividualData.map((card) => (
                ...
                >
                  ...
                  {(card.status !== "pending" && card.status !== "rejected" && card.status !== "printed") && (
                    <TableCell>
                      <button className="bg-[#00adef] text-white px-3 py-1 rounded hover:bg-[#00adef] transition duration-300" onClick={() => handleModal("print", card)}>Print</button>
                      <button className="bg-red-700 ml-4  text-white px-3 py-1 rounded hover:bg-red-700 transition duration-300" onClick={() => handleModal("reject", card)}>Reject</button>
                    </TableCell>
                  )}
                </TableRow>
              ))}
                ...
                group.confirmed_cards.map((member, index) => (
                  ...
                  >
                    ...
                    <button 
                            ...
                            >Print</button>
                      <button className="bg-red-700 ml-4  text-white px-3 py-1 rounded hover:bg-red-700 transition duration-300" onClick={() => handleModal("reject", group)}>Reject</button>
                    </TableCell>
                  </TableRow>
                ))
              )}
